...
<div class="header__logo"><img class="header__img" src="./assets/logo.png"> <h1 class="header__title">Faith Christian Academy of Rodriguez Rizal<span class="header__light">, Inc</span></h1></div> 
  ...
  <div class="header__menu">
    <nav id="navbar" class="header__nav collapse">
      <ul class="header__elenco">
        ...
        <li class="header__el"><a href="admin.php" class="header__link">Enrollment</a></li>
        <li class="header__el"><a href="#" class="header__link">Store</a></li>
        <li class="header__el"><a href="#" class="header__link">About Us</a></li>
      
        <li class="header__el header__el--blue"><a href="../l/login.php" class="btn btn--white">Sign In →</a></li>
      </ul>
    </nav>
  </div>
    </div>
...
<div class="sect sect--padding-top">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
    <div class="site">
		<h1 class="site__title">The Foundation of Excellence</h1>
      
      <h2 class="site__subtitle">To educate all students to the highest levels of academic achievement, <br>to enable them to reach and exceed their potential as lifelong learners and productive members of society.</h2>
